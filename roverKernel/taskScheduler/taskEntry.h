...
class TaskEntry
{
    ...
    public:
        ...
        uint8_t     GetLibUID() const volatile;
        uint8_t     GetTaskUID() const volatile;
        uint16_t    GetPID() const volatile;
        int32_t     GetPeriod() const volatile;
        uint32_t    GetTimeStamp() const volatile;
